# Claude Code Project Summary Reusable Workflow
...
jobs:
  generate-summary:
    uses: nakamasato/github-actions/.github/workflows/reusable-claude-code-project-summary.yml@main
    with:
...
3. **Claude Code/Anthropic**: APIアクセス権限（`claude_code_oauth_token`または`anthropic_api_key`のいずれか一つが必要）
